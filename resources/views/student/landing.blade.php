...
<style>
    ...
    .logo-text { font-size: 1.5rem; font-weight: 800; letter-spacing: -0.03em; display: inline-flex; align-items: center; gap: 0.4rem; }
        ...
        <div class="site-container">
            <div class="flex h-16 md:h-20 items-center justify-between gap-3">
                <a href="{{ route('student.landing') }}" class="logo-text no-underline flex items-center gap-2">
                    <span style="color: #2563eb;">Quiz</span><span style="color: #fbbf24;">Snap</span>
                </a>
