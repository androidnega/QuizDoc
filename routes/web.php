...
Route::middleware('admin.auth')->group(function () {
    ...
    // GET /dashboard is handled by DashboardGatewayController (unified)
        ...
        Route::middleware('docu-mentor.supervisor')->prefix('docu-mentor')->name('docu-mentor.')->scopeBindings()->group(function () {
            ...
            Route::post('/projects/{project}/chapters/{chapter}/toggle-submissions', [\App\Http\Controllers\DocuMentor\SupervisorChapterController::class, 'toggleAllSubmissions'])->name('chapters.toggle-submissions');
            Route::post('/projects/{project}/chapters/{chapter}/submissions', [\App\Http\Controllers\DocuMentor\SupervisorSubmissionController::class, 'store'])->name('submissions.store');
            Route::put('/projects/{project}/chapters/{chapter}/submissions/{submission}', [\App\Http\Controllers\DocuMentor\SupervisorSubmissionController::class, 'update'])->name('submissions.update');
            Route::delete('/projects/{project}/chapters/{chapter}/submissions/{submission}', [\App\Http\Controllers\DocuMentor\SupervisorSubmissionController::class, 'destroy'])->name('submissions.destroy');
            ...
            Route::post('/projects/{project}/chapters/{chapter}/submissions/{submission}/ai-review', [\App\Http\Controllers\DocuMentor\SupervisorAiController::class, 'reviewSubmission'])->name('ai.review-submission');
